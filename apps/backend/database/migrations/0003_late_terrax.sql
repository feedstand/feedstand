...
ALTER TABLE "items" ADD COLUMN "item_checksum" varchar NOT NULL;--> statement-breakpoint
ALTER TABLE "items" ADD COLUMN "content_checksum" varchar NOT NULL;--> statement-breakpoint
