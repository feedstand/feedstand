...
describe('chooseFeedUrl', () => {
  ...
  describe('when selfUrl targets private/internal resources (SSRF protection)', () => {
    /**
     * Setup:
  ...
  describe('when fetchUrl throws error', () => {
    /**
     * Setup:
  ...
  describe('when selfUrl returns non-2xx status', () => {
    /**
     * Setup:
     * - selfUrl different from responseUrl
     *
  ...
  describe('when selfUrl redirects to responseUrl', () => {
    /**
     * Setup:
  ...
  describe('when selfUrl is similar to responseUrl after normalizing', () => {
    /**
     * Setup:
  ...
  describe('when selfUrl has different URL but same content hash', () => {
    /**
     * Setup:
     * - selfUrl = https://cdn.example.com/feed.xml
     * - responseUrl = https://example.com/feed.xml
